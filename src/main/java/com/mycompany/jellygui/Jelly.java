...
package com.mycompany.jellygui;
...
public class Jelly {
    ...
    public Jelly(String manufacturer, float price, String flavour, float noOfCalories, String
    expiryDate){
    ...
    public Jelly(String manufacturer, float price, String flavour, float noOfCalories){
